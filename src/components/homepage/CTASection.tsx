        ...
        <ScrollReveal delay={0.2}>
          <div className="mt-12 flex flex-col sm:flex-row items-center justify-center gap-4">
            <a
              ...
              className="inline-flex items-center gap-2 px-6 py-3 border border-border rounded-sm text-sm text-text-primary hover:border-border-hover hover:bg-bg-glass transition-all duration-200"
            >
