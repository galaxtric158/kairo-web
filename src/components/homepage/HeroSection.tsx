  ...
  return (
    <section className="relative min-h-[100dvh] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-[1200px] mx-auto px-6 text-center">
        <h1 className="font-mono text-display text-6xl sm:text-7xl md:text-8xl font-semibold text-text-primary leading-none animate-hero-title">
          KAIRO
        </h1>

        <div className="mt-8 font-mono text-ui text-sm text-accent tabular-nums animate-hero-subtitle">
